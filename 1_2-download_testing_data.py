        ...
        for item in items:
            ...
            if taxon_url in taxon_urls:
                ...
                if len(audio_urls) > 0:
                    ...
                    audio_data = json.load(urllib.request.urlopen(audio_url))
