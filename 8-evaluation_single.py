...
def main(graph_path):
    ...
    shape = np.shape(testing_data)
    testing_data = np.reshape(testing_data, (shape[0], shape[1], shape[2], 1))
    ...
    with tf.Session() as persisted_sess:
        ...
        for i in range(int(testing_data.shape[0] / siuts.test_batch_size)):
